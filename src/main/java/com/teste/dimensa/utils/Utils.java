...
public class Utils {
    ...
    public static boolean validarTelefone(String telefone) {
        ...
        Pattern p = java.util.regex.Pattern.compile(telefone.charAt(0)+"{"+telefone.length()+"}");
        ...
        if (!asList(codigosDDD).contains(Integer.parseInt(telefone.substring(0, 2)))) return false;
        ...
        if (telefone.length() == 10 && !asList(prefixos).contains(Integer.parseInt(telefone.substring(2, 3)))) return false;
